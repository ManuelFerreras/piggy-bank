...
export default ({ withdrawErcFunds, login, connected, setConnected, accountBalance, contractBalance, accountStoredBalance, openWithdrawMenu, openDashboardMenu }) => {
    ...
    return(
        ...
        <div className='container dashboard'>
            ...
            <div className='dashboardBg'>
                <h2 className='text-center dashboardHeader'>Withdraw ERC20 Token</h2>
                ...
                <div className='storeInfo'>
                    ...
                    <div className="input-group erc">
                        <label htmlFor="amountStore">Amount of Tokens to Wtidraw</label>
                ...
                <div className='dashboardButtons'>
                    {connected ? (
                        ...
                        <button id="inputValue" className='btn btn-store-ether' onClick={() => {
                            ...
                            withdrawErcFunds(inputToken.current.value, inputTokens.current.value);
